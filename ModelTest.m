...
Test5: same Arch
Test6: same Class
Test7: same superfamily but less than 35% identical
Test8: same superfamily but less than 35% identical
Test9: same superfamily but less than 35% identical(new superfamily)
Test10: same topol from test9
%}
%% sprMDL auto testing
clear
...
%% Test7: same superfamily but less than 35% identical
proteinARGs_7 = cell(0);
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/1hx2A00.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/1moxD00.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/1n7dA10.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/2flgA00.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/2oyuP01.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/2w2mE00.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/3soqA02.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/4cudA01.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/4jzeL00.csv');
proteinARGs_7{end+1} = GenerateProteinARG('protein/test7/4lmfA02.csv');

%% Test8: same superfamily but less than 35% identical
proteinARGs_8 = cell(0);
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1ataA00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1autL01.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1bf9A00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1g1rC02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1hj7A02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1hx2A00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1k37A00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1n7dA08.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1npeB02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1nt0G02.csv');

proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1tpgA02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1uzqA03.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1yo8A03.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/1z6cA00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/2bz6L00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/2k2tA00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/2mgrA01.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/2nprA02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/2rhpA02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/2rnlA00.csv');

proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3c9aD00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3fbyB01.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3gcxE00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3poyA06.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3qcwB03.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3sovA02.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/3u7uL00.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/4bxwB01.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/4cudA03.csv');
proteinARGs_8{end+1} = GenerateProteinARG('protein/test8/4o02B05.csv');

%% Test9: same superfamily but less than 35% identical(new superfamily)
proteinARGs_9 = cell(0);
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1aipD03.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1g3iU02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1g4aF02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1hjpA03.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1ixrB03.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1kyiU02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1mn3A00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1nv9A01.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1oaiA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1oksA00.csv');

proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1oqyA02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1otrA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1pgyA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1tr8B02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1tteA02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1v92A00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1wj7A01.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/1xb2B01.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2dnaA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2dzlA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2ekkA00.csv');

proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2g3qA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2l2dA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2l4fA00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2lbcA02.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2lvaA01.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/2mj5B00.csv');
proteinARGs_9{end+1} = GenerateProteinARG('protein/test9/3e21A00.csv');
...
original_score_7 = scores(proteinARGs_7, mdl);
original_score_8 = scores(proteinARGs_8, mdl);
